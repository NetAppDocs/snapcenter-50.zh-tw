...
如果您使用的是 Microsoft SQL Server 的 SnapManager 、而且想要將資料從 SnapManager for Microsoft SQL Server 匯入 SnapCenter 、請參閱 link:../protect-scsql/concept_import_archived_backups_from_snapmanager_for_sql_to_snapcenter.html["匯入歸檔備份"^]
