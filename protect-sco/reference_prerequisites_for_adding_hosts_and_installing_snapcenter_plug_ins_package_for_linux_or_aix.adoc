...
您應該檢閱Oracle資料庫支援的不同驗證方法。如需相關資訊，請參閱 link:../install/concept_authentication_methods_for_your_credentials.html["認證方法"^]。
...
+
如需更多資訊、請參閱 link:../protect-sco/task_define_a_backup_strategy_for_oracle_databases.html#preferred-nodes-in-rac-setup["RAC設定中的慣用節點"^]。
