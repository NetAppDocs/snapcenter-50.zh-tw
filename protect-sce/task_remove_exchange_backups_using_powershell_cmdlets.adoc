...
您可以執行_Get-Help命令name_來取得可搭配Cmdlet使用之參數及其說明的相關資訊。或者、您也可以參閱 https://docs.netapp.com/us-en/snapcenter-cmdlets-50/index.htmll["《軟件指令程式參考指南》SnapCenter"^]。
...
----
. 使用 Cmdlet 刪除一或多個備份 `Remove-SmBackup` 。
+
此範例使用兩個備份ID刪除兩個備份：
