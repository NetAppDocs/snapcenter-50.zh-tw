...
如果 SnapCenter PowerShell Cmdlet 因從伺服器移除 SnapDrive for Windows 而中斷，請參閱 https://kb.netapp.com/Advice_and_Troubleshooting/Data_Protection_and_Security/SnapCenter/SnapCenter_cmdlets_broken_when_SnapDrive_for_Windows_is_uninstalled["解除安裝適用於Windows的功能時、無法使用的Cmdlet SnapCenter SnapDrive"^]。
